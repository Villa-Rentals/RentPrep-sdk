...
var SmartMove = function (_Base) {
  ...
  function SmartMove(args) {
    _classCallCheck(this, SmartMove);

    var _this = _possibleConstructorReturn(this, (SmartMove.__proto__ || Object.getPrototypeOf(SmartMove)).call(this, args));
...
var Base = function () {
  ...
  _createClass(Base, [{
    ...
    value: function formatUrl(path) {
      var domain = 'sandbox.api.intuit.com';
      if (this.production) {
