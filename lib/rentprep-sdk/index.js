(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("rentprep-sdk", [], factory);
	else if(typeof exports === 'object')
		exports["rentprep-sdk"] = factory();
	else
		root["rentprep-sdk"] = factory();
...
var _smartMove = __webpack_require__(15);

var _smartMove2 = _interopRequireDefault(_smartMove);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var RentPrep = function () {
  function RentPrep(args) {
    _classCallCheck(this, RentPrep);

    this.production = args.production;
    this.key = args.key;
  }

  _createClass(RentPrep, [{
    key: 'SmartMove',
    value: function SmartMove() {
      return new _smartMove2.default({
...
var SmartMove = function (_Base) {
  _inherits(SmartMove, _Base);

  function SmartMove() {
    _classCallCheck(this, SmartMove);

    return _possibleConstructorReturn(this, (SmartMove.__proto__ || Object.getPrototypeOf(SmartMove)).apply(this, arguments));
  }

  _createClass(SmartMove, [{
    key: 'create',
     ...
     */
    value: function create(application, product, customer, property) {
    ...
    key: 'createNatively',
    value: function createNatively(application, product, customer, property, card) {
    ...
    key: 'removeApplicant',
    value: function removeApplicant(applicationId, referenceId, email) {
    ...
    key: 'addApplicant',
    value: function addApplicant(applicationId, referenceId, email) {
    ...
    key: 'getById',
    value: function getById(applicationId, referenceId) {
    ...
    key: 'get',
    value: function get(referenceId) {
    ...
    value: function cancelApplication(applicationId, referenceId) {
    ...
    key: 'getReportURL',
    value: function getReportURL(applicationId, referenceId) {
    ...
    key: 'getReportStatus',
    value: function getReportStatus(applicationId, referenceId) {
